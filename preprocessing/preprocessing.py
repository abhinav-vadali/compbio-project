...
#train_dataset = datasets.ImageFolder(root = "preprocessing/train", transform = train_transforms)
#test_dataset = datasets.ImageFolder(root = "preprocessing/test", transform = test_transforms)
